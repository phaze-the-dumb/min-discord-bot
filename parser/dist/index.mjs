...
async function resolveAssets(info) {
    if (typeof window !== 'undefined') {
        ...
        return path => Canvas.loadImage(new URL(basicJoin(base.pathname, path), base).href);
    }
    if (!assetsFolder) {
    ...
    return path => Canvas.loadImage(basicJoin(assetsFolder, path));
}
...
export { Blocks, Items, Liquids, Schematic, SchematicTile, index$1 as arc, index as mindustry };
